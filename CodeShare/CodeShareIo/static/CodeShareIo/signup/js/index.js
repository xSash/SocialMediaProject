...
$('#bio').keyup(function(e) {
    while ($('#bio').val().length < 2 && $('#bio').val().length > 0) {
        $('#bio').css("border", "1px solid #FF0000");
        $('#bio').focus(function() {
            $('#bio').css("border", "1px solid #66afe9");
        })
        $('#bio').css("box-shadow", "inset 0 1px 1px rgba(0, 0, 0, 0.075)");
        return;
    }
    if ($('#bio').val().length >= 2) {
        $('#bio').css("border", "1px solid #40D127");
        $('#bio').css("box-shadow", "inset 0 1px 1px rgba(0, 0, 0, 0.075)");
        bio = $('#bio').val();
    } else {
        $('#bio').css("border", "1px solid #d4dbe0");
        $('#bio').css("box-shadow", "inset 0 1px 1px rgba(0, 0, 0, 0.075)");
    }
});
// ========================================= End First Name Verifications ================================================== //
...
if(firstname != null && lastname != null && username != null && imagepath != null && email != null && mobilenumber != null && password != null && birthday != null && country != null && city != null && gender != null && bio != null && $("#terms").is(':checked')){
